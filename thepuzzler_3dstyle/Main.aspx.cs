...
namespace thepuzzler_3dstyle  
{
	...
	public class MainWebForm : System.Web.UI.Page
	{
		...
		private void SolvePuzzle_Click(object sender, System.EventArgs e)
		{
			...
			{
				list_counter = managestats.GetSolutionTime( ref StatisticsView, statistics );
		...
		public void LoadStatistics()
		{
			...
			managestats.GetPuzzleTime( ref StatisticsView, statistics );
			// Write out the Html.
			StatisticsView.RenderControl( writer );
		...
		{
			// Cause post back and/or auto post back by clicking.
		}
