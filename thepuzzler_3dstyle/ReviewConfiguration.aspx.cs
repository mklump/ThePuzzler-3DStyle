...
//						break;
			...
			else
			{
				StatusPanel.InnerHtml = "\r\n\t\t\t\t<P><FONT size=\"4\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp" +
					...
					"sp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&n" + 
					"bsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + 
					"&nbsp;&nbsp;&nbsp;&nbsp;<STRONG>Configuration\r\n\t\t\t\t\t\t\tOkay!</STRONG></FONT></P>\r" + 
					"\n\t\t\t\t<UL>\r\n\t\t\t\t\t<LI>\r\n\t\t\t\t\t\t<FONT size=\"4\">Click \"Yes\" one more time" + 
					" to proceed to the main page or \"No\" to\r\n\t\t\t\t\t\t\tgo back and re-enter.</FONT>\r" + 
					"\n\t\t\t\t\t<LI>\r\n\t\t\t\t\t\t<FONT size=\"4\">Extremely large values will cause the appl" + 
					"ication to stop \r\n\t\t\t\t\t\t\tresponding.</FONT>\r\n\t\t\t\t\t<LI>\r\n\t\t\t\t\t\t<FONT" + 
					" size=\"4\">Tips for the Dictionary: </FONT>\r\n\t\t\t\t\t\t<UL>\r\n\t\t\t\t\t\t\t<LI>\r\n" + 
					...
					"\t\t\t\t\t\t<LI>\r\n\t\t\t\t\t\t\tOn base dictionary #3, the size should not be more than 2" + 
					"13,558 words.\r\n\t\t\t\t\t\t\t<LI>\r\n\t\t\t\t\t\t\tOn base dictionary #4, the size should" + 
					" not be more than 869,230 words.\r\n\t\t\t\t\t\t\t<LI>\r\n\t\t\t\t\t\t\t\tThe Minimum Word " + 
					"Length should be at least 3 characters and not more than any \r\n\t\t\t\t\t\t\t\tlength of " + 
					"the puzzle.</LI></UL>\r\n\t\t\t\t\t<LI>\r\n\t\t\t\t\t\t<FONT size=\"4\">Tips for the Puzzle:" + 
					" </FONT>\r\n\t\t\t\t\t\t<UL>\r\n\t\t\t\t\t\t\t<LI>\r\n\t\t\t\t\t\t\tThe puzzle lengths/meas" + 
					"urements can be anything, however,\r\n\t\t\t\t\t\t\t<LI>\r\n\t\t\t\t\t\t\t\tthe puzzle leng" + 
					"ths/measurements longer than 100 tend to take exponentially \r\n\t\t\t\t\t\t\t\tlonger to c" + 
					"reate and to solve.</LI></UL>\r\n\t\t\t\t\t</LI>\r\n\t\t\t\t</UL>\r\n\t\t\t";
				Config_Question.Style.Remove( "FONT-SIZE" );
				Config_Question.Style.Add( "FONT-SIZE", "32pt" );
