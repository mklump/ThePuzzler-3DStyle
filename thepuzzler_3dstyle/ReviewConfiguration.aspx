	...
	<body MS_POSITIONING="GridLayout">
		<form id="ReviewConfigForm" method="post" runat="server">
			...
			<asp:button id="buttonNORESPONSE" style="Z-INDEX: 104; LEFT: 48px; POSITION: absolute; TOP: 488px"
				...
				BorderStyle="Outset"></asp:button>
			<DIV id="StatusPanel" style="BORDER-RIGHT: black thin solid; BORDER-TOP: black thin solid; DISPLAY: inline; Z-INDEX: 118; LEFT: 48px; BORDER-LEFT: black thin solid; WIDTH: 744px; BORDER-BOTTOM: black thin solid; POSITION: absolute; TOP: 16px; HEIGHT: 320px; BACKGROUND-COLOR: lightyellow"
				runat="server" ms_positioning="FlowLayout">
				<P><FONT size="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<STRONG>Review 
							Configuration</STRONG></FONT></P>
				<UL>
					<LI>
						<FONT size="4">Please review the dictionary and puzzle specifications. To 
							proceed&nbsp;click "Yes" to check the&nbsp;specifications or click "No" to go 
							back and re-enter the specifications.</FONT>
					<LI>
						<FONT size="4">Extremely large values will cause the application to stop 
							responding.</FONT>
					<LI>
						<FONT size="4">Tips for the Dictionary: </FONT>
						<UL>
							<LI>
					...
					<LI>
						<FONT size="4">Tips for the Puzzle: </FONT>
						<UL>
							<LI>
			...
			<asp:Button id="HELP" style="Z-INDEX: 123; LEFT: 688px; POSITION: absolute; TOP: 488px" runat="server"
				Height="72px" Width="104px" Font-Bold="True" Text="HELP" Font-Size="Large" BorderStyle="Outset"></asp:Button></form>
	</body>
</HTML>
